<p align="center">
  <img src="behvaioral-repo-logo.png" width="350" height="200">
</p>
...
<ul>
    <li>
        <b>Situation: </b>When I joined a new project, I was hired primarily as a Java developer. However, I soon discovered that most of the backend services in the project were written in Go (Golang), a language I had little to no prior experience with.
    </li>
    <li>
        <b>Task: </b>I realized that if I chose to work only on the limited Java components, my contributions to the project would be minimal and I wouldn't gain a comprehensive understanding of the system. I wanted to become an effective team member who could work across the stack and add real value.
    </li>
    <li>
        <b>Action: </b>Despite being out of my comfort zone, I proactively decided to learn Golang. I started by going through official documentation, online tutorials, and real-world project examples in my spare time. I also sought guidance from team members who were experienced with Go, participated in code reviews, and gradually began taking up tasks related to Go services. I ensured I wasn’t just writing code, but also understanding architectural patterns, concurrency models, and Go best practices.
    </li>
    <li>
        <b>Result: </b>Over time, I became comfortable working with both Java and Go services. I was able to contribute meaningfully across the backend codebase, which improved my understanding of the overall system and increased my value to the team. This experience taught me the importance of adaptability and continuous learning. It also reinforced that stepping out of your comfort zone is often the key to unlocking new opportunities and accelerating growth in your career.
    </li>
</ul>
</details>
<details>
...
<li>
The accomplishment I am most proud of in my career is designing and developing a robust, multilingual, in-house search system using Elasticsearch for a B2B sportsbook SaaS platform.

This project was particularly impactful because it addressed a core user experience issue in the sports betting domain — enabling users across different client websites and regions to quickly and accurately find relevant events, competitions, or markets in their local language.

When I joined the team, the platform was heavily reliant on third-party search tools that were rigid and didn’t offer the flexibility or customization needed for our diverse client base. I led the effort to build a scalable and fully customizable search engine using Elasticsearch from the ground up.
</li>
Key features included:
<ul>
Multilingual search support to cater to various regions and local languages.

Per-client customization allowing clients to boost or prioritize specific competitions, events, or markets based on their business preferences.

Fuzzy search and typo tolerance, ensuring better user experience even with misspelled or partial inputs.

Popularity-based suggestions, displaying trending or frequently searched events to enhance discoverability and engagement.

Flexible sorting and weighting, giving clients control over how search results are ranked for their users.
</ul>
The new search system replaced a dependency on external tools, reduced search latency by ~40%, and improved user engagement metrics — including a measurable increase in successful search results and session duration on betting platforms. It also reduced operational overhead as new markets and languages could be onboarded more easily.

This accomplishment stands out to me not just for the technical depth — working with Elasticsearch, data modeling, and search relevance tuning — but also for the strategic value it delivered to the business. It empowered our clients with tailored search experiences, improved user satisfaction, and gave our product a competitive edge in the sportsbook SaaS space.
    </li>
</ul>
</details>
<details>
