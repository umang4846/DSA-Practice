...
public class SortAStack {
    ...
    {
        // Base case: Either dsa.stack is empty or newly
    ...
    // Method to sort dsa.stack
    static void sortStack(Stack<Integer> s)
    {
        // If dsa.stack is not empty
        if (!s.isEmpty())
        {
            // Remove the top item
            int x = s.pop();
            // Sort remaining dsa.stack
            sortStack(s);
            // Push the top item back in sorted dsa.stack
            sortedInsert(s, x);
        }
    }
